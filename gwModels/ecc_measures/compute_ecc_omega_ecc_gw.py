...
class ComputeEccentricityFromOmega:
    ...
    def __init__(self, time_xi, xi_lower, xi_upper, gwnrhme_obj, ecc_prefactor, t_ref):
        ...
        # build interpolation
        self.ecc_omega_22_interp = interpolate.interp1d(self.time_xi, self.ecc_omega22)
        self.ecc_gw_interp = interpolate.interp1d(self.time_xi, self.ecc_gw)
    ...
    def compute_psi(self):
        """
        Compute psi transformation for correct Newtonian limit.
    ...
    def _compute_ecc_omega_22_at_tref(self):
        """Compute eccentricity ecc_omega_22 at t_ref."""
    ...
    def _compute_ecc_gw_at_tref(self):
        """Compute eccentricity ecc_gw at t_ref."""
    ...
    def plot_omega_22_with_peaks_and_fits(self, figsize=(8, 5)):
        """Plot eccentric omega_22 with upper and lower envelope fits."""
        import matplotlib.pyplot as plt
        plt.figure(figsize=figsize)
